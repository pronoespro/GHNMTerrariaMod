...
{
    class DarkFist : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Dark Fist");
        }
        ...
        public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox)
        {
            ...
            int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height, DustID.Granite, newColor: Color.Black, Scale: 0.5f);
        ...
        public override void AI()
        {
            ...
            {
                dustTimer = 5;
                int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height, DustID.Granite, SpeedX: projectile.velocity.X / 2, SpeedY: projectile.velocity.Y / 2, newColor: Color.Black, Scale: 1.1f);
            }
            //copypasted
